...
@WebServlet("/member/signUpEmail")
public class SignUpEmail extends HttpServlet{

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String subject = "[dorandoran] 회원가입 인증번호"; // 제목
	      String fromEmail = "kh.dorandoran@gmail.com"; // 보내는 사람으로 표시될 이메일
	      String fromUsername = "관리자"; // 보내는 사람 이름
	      String memberId = req.getParameter("memberId");
	      String toEmail = memberId; // 받는사람, 콤마(,)로 여러개 나열 가능
		  
	      
	      final String smtpEmail = "kh.dorandoran@gmail.com"; // 이메일
	      final String password = "klkofpwgybqmsyup"; // 발급 받은 비밀번호
	      ...
	      try {
	         ...
	         sb.append("<h3>[dorandoran] 회원가입 인증번호 입니다.</h3>\n");
